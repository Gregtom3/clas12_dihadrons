...
def make_plots(x,y,ypred,savedir,suffix):
...
def plot_confusion_matrix(cf,
    ...
    plt.savefig(f"{savedir}/eval_plots/conf_p_{p}_{suffix}.png")
    
def plot_roc_curve(y,ypred,savedir,suffix):
    ...
    plt.savefig(f"{savedir}/eval_plots/roc_{suffix}.png")